...
*/
__device__ inline BLOB_T _compute_disk_overlap(const BLOB_T d, const BLOB_T r1, const BLOB_T r2)
{
...
/*@func _compute_sphere_overlap
    ...
    for more details.
*/
__device__ inline BLOB_T _compute_sphere_overlap(const BLOB_T d, const BLOB_T r1, const BLOB_T r2)
{
...
*/
__device__ inline BLOB_T _blob_overlap(BLOB_T* blob1, BLOB_T* blob2, const long long sigma_dim, const long long n)
{
...
extern "C" __global__ void _prune_blobs_kdtree(const long long* pairs,
...
extern "C" __global__ void _prune_blobs(
    BLOB_T* blobs_array, const long long n_rows, const long long n_cols, const double overlap, long long sigma_dim)
{
